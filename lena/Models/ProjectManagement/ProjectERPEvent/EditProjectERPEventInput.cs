...
{
  public class EditProjectERPEventInput
  {
    ...
    public DateTime? CRMDateTime { get; set; }
    ...
    public DeleteProjectERPEventDocumentInput[] DeleteProjectERPEventDocumentInputs { get; set; }
  }
}
