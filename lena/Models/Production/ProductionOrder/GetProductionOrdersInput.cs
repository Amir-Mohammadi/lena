...
{
  public class GetProductionOrdersInput : SearchInput<ProductionOrderSortType>
  {
    ...
    public GetProductionOrdersInput(PagingInput pagingInput, ProductionOrderSortType sortType, SortOrder sortOrder) : base(pagingInput, sortType, sortOrder)
    {
    }
  }
}
