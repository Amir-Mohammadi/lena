...
{
  public class EditEmployeeComplainItemInput
  {
    ...
    public EditEmployeeComplainDepartmentInput[] EditEmployeeComplainDepartmentInput { get; set; }
    public int[] DeleteEmployeeComplainDepartmentInputs { get; set; }
