...
{
  public class GeneralStuffRequestFullResult
  {
    ...
    public byte? WarehouseAvailableUnitId { get; set; }
    ...
    public IQueryable<int?> RequestConfirmerUserGroupIds { get; set; }
    public IQueryable<string> RequestConfirmerUserGroupRawNames { get; set; }
