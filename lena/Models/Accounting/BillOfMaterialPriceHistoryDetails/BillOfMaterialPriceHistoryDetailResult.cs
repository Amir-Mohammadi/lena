...
{
  public class BillOfMaterialPriceHistoryDetailResult
  {
    ...
    public byte[] BillOfMaterialPriceHistoryDetailRowVersion { get; set; }
    public byte[] BillOfMaterialPriceHistoryRowVersion { get; set; }
