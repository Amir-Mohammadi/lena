...
{
  public class GetStoreReceiptsInput : SearchInput<StoreReceiptSortType>
  {
    public GetStoreReceiptsInput(PagingInput pagingInput, StoreReceiptSortType sortType, SortOrder sortOrder) : base(pagingInput, sortType, sortOrder)
    {
    }
