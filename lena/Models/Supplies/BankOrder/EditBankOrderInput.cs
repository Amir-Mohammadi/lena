...
{
  public class EditBankOrderInput
  {
    ...
    public EditBankOrderDetailInput[] EditBankOrderDetails { get; set; }
    public DeleteBankOrderDetailInput[] DeleteBankOrderDetails { get; set; }
  }
}
