...
{
  public class FullOrderItemChangeRequestResult
  {
    ...
    public IQueryable<OrderItemChangeConfirmationResult> OrderItemChangeConfirmations { get; set; }
    public int? BillOfMaterialVersion { get; set; }
    public string BillOfMaterialTitle { get; set; }
    public bool IsActive { get; set; }
    public bool OrderItemIsActive { get; set; }
