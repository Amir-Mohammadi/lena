...
{
  public class CheckTransactionBatchSerialLevelException : InternalServiceException
  {
    public List<CheckTransactionBatchInfo> Info { get; set; }

    public List<UncommitedTransaction> Transactions { get; set; }
    public CheckTransactionBatchSerialLevelException(List<CheckTransactionBatchInfo> info)
    {
      Info = info;
